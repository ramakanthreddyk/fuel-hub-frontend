      ...
      <div className="flex-1 space-y-3 sm:space-y-4 md:space-y-6 p-3 sm:p-4 md:p-6 lg:p-8">
        ...
        <div className="flex flex-col space-y-3 sm:space-y-4 lg:flex-row lg:items-center lg:justify-between lg:space-y-0">
          <div className="space-y-1">
            <h1 className="text-xl sm:text-2xl md:text-3xl lg:text-4xl font-bold tracking-tight bg-gradient-to-r from-green-600 to-blue-600 bg-clip-text text-transparent">
          ...
          <Button 
            size="sm" 
            className="w-full sm:w-auto bg-gradient-to-r from-green-600 to-blue-600 hover:from-green-700 hover:to-blue-700 text-xs sm:text-sm"
          >
        ...
        <div className="grid gap-2 sm:gap-3 md:gap-4 lg:gap-6 grid-cols-2 lg:grid-cols-4">
          <Card className="bg-gradient-to-br from-green-50 via-emerald-50 to-teal-50 border-green-200/50">
            ...
            <CardContent className="pt-0">
              <div className="text-lg sm:text-xl lg:text-2xl font-bold text-green-700 truncate">
          ...
          <Card className="bg-gradient-to-br from-blue-50 via-cyan-50 to-sky-50 border-blue-200/50">
            ...
            <CardContent className="pt-0">
              <div className="text-lg sm:text-xl lg:text-2xl font-bold text-blue-700 truncate">
          ...
          <Card className="bg-gradient-to-br from-purple-50 via-violet-50 to-indigo-50 border-purple-200/50">
            ...
            <CardContent className="pt-0">
              <div className="text-lg sm:text-xl lg:text-2xl font-bold text-purple-700 truncate">
          ...
          <Card className="bg-gradient-to-br from-orange-50 via-amber-50 to-yellow-50 border-orange-200/50">
            ...
            <CardContent className="pt-0">
              <div className="text-xs sm:text-sm lg:text-base font-bold text-orange-700 truncate">
        ...
        <Card className="border-2 border-gray-200/50">
          <CardHeader className="pb-3">
            <CardTitle className="text-base sm:text-lg md:text-xl truncate">Detailed Sales Transactions</CardTitle>
